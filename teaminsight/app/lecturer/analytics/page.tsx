                ...
                <div>
                    ...
                    {selectedTeamDetails.members && selectedTeamDetails.members.length > 0 ? (
                        <div className="flex flex-wrap items-center gap-2">
                            ...
                            {selectedTeamDetails.members.map((m, index) => (
                                <span key={`${m.memberId}-${index}`} className="px-2 py-1 bg-gray-100 text-gray-700 text-xs rounded-md border border-gray-200">
                                    {m.displayName}
                                </span>
                            ))}
                        </div>
